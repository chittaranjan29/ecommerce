...
public User getCustomerById(int customerId) {
		...
		return dao.findById(customerId).orElseThrow(()->new exceptions.ResourceNotFoundException("Customer"));
	}
	...
	User existingCustomer=dao.findById(customerId).orElseThrow(()->new exceptions.ResourceNotFoundException("Customer"));	
...
//	existingCustomer.setDistrict(customer.getDistrict());
	...
	public void deleteCustomer(int customerId) {
		dao.findById(customerId).orElseThrow(()->new exceptions.ResourceNotFoundException("Customer"));
